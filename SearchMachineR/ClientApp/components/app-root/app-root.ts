...
const routes: Route[] = [
    ...
    { url: 'search-machine', params: { page: 'search-machine' } },
    { url: 'search-machinev2', params: { page: 'search-machinev2' } }
];
...
class AppRootViewModel {
    ...
    constructor(params: { history: History.History, basename: string }) {
        ...
        ko.components.register('search-machine', require('bundle-loader?lazy!../search-machine/search-machine'));
        ko.components.register('search-machinev2', require('bundle-loader?lazy!../search-machinev2/search-machinev2'));
    }
